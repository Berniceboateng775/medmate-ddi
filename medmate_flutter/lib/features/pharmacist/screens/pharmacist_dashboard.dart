...
class _PharmacistDashboardState extends State<PharmacistDashboard> {
  ...
  Future<void> _loadDashboardData() async {
    ...
    try {
      ...
      // Load patient count
      final patientsRes = await api.dio.get('/api/pharmacist/patients/');
      final patients = patientsRes.data is List
          ? patientsRes.data
          : patientsRes.data['results'] ?? [];
      final patientCount = patients.length;

      // Load prescription checks count (placeholder)
      final prescriptionChecksCount = 0;

      // Load inventory alerts count (placeholder)
      final inventoryAlertsCount = 0;
      ...
      setState(() {
        stats = {
          ...
          'prescriptionChecksToday': prescriptionChecksCount,
                    ...
                    builder: (context, constraints) {
                      ...
                      return GridView.count(
                        ...
                        children: [
                          ...
                          _buildStatCard(
                            'Prescription Checks Today',
                            stats?['prescriptionChecksToday']?.toString() ?? '0',
                            Icons.check_circle,
                            Colors.purple,
                            isDark,
                          ),
                          _buildStatCard(
                            'Inventory Alerts',
                            stats?['inventoryAlerts']?.toString() ?? '0',
                            Icons.warning,
                            Colors.orange,
                            isDark,
                          ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Most dispensed / restocked medications this month',
                            style: TextStyle(
                              color:
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8),
                          Text(
                            'Common pharmacy tasks and tools',
                            style: TextStyle(
                              color:
                                  isDark ? Colors.grey[300] : Colors.grey[600],
                            ),
                          ...
                          GridView.count(
                            ...
                            children: [
                              ...
                              _buildQuickActionButton(
                                ...
                                Colors.blue,
                                () => _showMessage(
                                    'Opening Inventory Management', 'info'),
                                isDark,
                              ),
                              _buildQuickActionButton(
                                'Dispense Medication',
                                ...
                                Colors.purple,
                                () => _showMessage(
                                    'Opening Dispense Medication', 'info'),
                                isDark,
                              ),
                              _buildQuickActionButton(
                                'Patient Search',
                              ...
                              _buildQuickActionButton(
                                ...
                                Colors.indigo,
                                () => _showMessage(
                                    'Opening Prescription Validation', 'info'),
                                isDark,
                              ),
                            ],
                          ),
