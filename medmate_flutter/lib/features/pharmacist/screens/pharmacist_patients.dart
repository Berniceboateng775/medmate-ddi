...
class PharmacistPatients extends StatefulWidget {
  const PharmacistPatients({super.key});
  @override
  State<PharmacistPatients> createState() => _PharmacistPatientsState();
}

class _PharmacistPatientsState extends State<PharmacistPatients> {
  ...
  Future<void> _load({bool reset = false}) async {
    ...
    try {
      ...
      // Use pharmacist endpoint
      final r = await _api.dio.get(
        '/api/pharmacist/patients/',
        queryParameters: {
          if (q.isNotEmpty)
            ...
            onTap: id.isEmpty
                ...
                : () {
                    WidgetsBinding.instance.addPostFrameCallback((_) {
                      context.go('/pharmacist/patient/$id');
                    });
                  },
            borderRadius: BorderRadius.circular(12),
            child: Padding(
