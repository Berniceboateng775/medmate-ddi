                ...
                <div className="border-t border-gray-200 pt-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                      ...
                      <button
                        onClick={() => navigate('/pharmacist/2fa-setup')}
                ...
                <div className="space-y-6">
                  <div className="border border-gray-200 rounded-lg p-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <label className="flex items-center justify-between">
                        <div>
                          <span className="font-medium text-gray-900">Prescription Requests</span>
                          <p className="text-sm text-gray-500">Receive notifications for prescription requests</p>
                        </div>
                        <input
                          type="checkbox"
                          defaultChecked
            ...
            {activeTab === "preferences" && (
              <div className="space-y-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="border border-gray-200 rounded-lg p-6">
                    <h3 className="font-medium text-gray-900 mb-4">Pharmacy Preferences</h3>
                    <div className="space-y-4">
                      <div>
                      ...
                      <label className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Automatically check for interactions when dispensing</p>
                        </div>
                        <input
                          type="checkbox"
                          defaultChecked
