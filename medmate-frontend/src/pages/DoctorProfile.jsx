            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900">
                  {profile?.name || `${profile?.first_name || ""} ${profile?.last_name || ""}`.trim() || "Doctor"}
                </h2>
                <p className="text-emerald-600 font-medium">{profile?.specialization || "General Medicine"}</p>
                <p className="text-gray-600">{profile?.role || "Doctor"}</p>
              </div>
            </div>
          </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="font-medium text-gray-900">{profile?.role || "Doctor"}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                      <svg
                      ...
                      <div>
                        ...
                        <p className="font-medium text-gray-900">{profile?.specialization || "General Medicine"}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                      <svg
